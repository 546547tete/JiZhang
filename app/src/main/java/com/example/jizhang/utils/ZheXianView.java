...
public class ZheXianView extends View {
    ...
    public void initView() {
        ...
        effectPaint.setColor(Color.parseColor("#f08080"));
        ...
        effectPaint1.setColor(Color.parseColor("#f08080"));
        ...
        if (start) {
            ...
            if (mapx.size() > 0) {
                ...
                for (int i = 0; i < o.length; i++) {
                    ...
                    float y = yuandiany - (wigth - gao) / max * mapx.get(o[i]);
                    ...
                    if (i > 0) {
                        canvas.drawLine(yandianx + i * kuan, yuandiany - (wigth - gao) / max * mapx.get(o[i - 1]), x, y, XPaint);
                    }
                    int size = dp2px(3);
